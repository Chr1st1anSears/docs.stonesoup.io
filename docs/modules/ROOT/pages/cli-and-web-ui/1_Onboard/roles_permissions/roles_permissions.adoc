...
As a workspace owner, you can invite one or more collaborators to your workspace by adding their user ID, such as an external SSO ID. After adding a user to a workspace, you assign them a specific role that determines the actions they can take in a workspace.

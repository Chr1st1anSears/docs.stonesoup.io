...
For information about deleting an application from CLI, refer to xref:cli-and-web-ui/3_Customize/c_Deploy/cli_delete_application.adoc[Deleting an application from CLI].